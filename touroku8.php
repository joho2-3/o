...
/*    print $title?><br><?php ;
    print $author?><br><?php ;
   print $manufacturer?><br><?php ;*/

    ?>
    <form method="get" action="abc.php" >
    商品コード：<input type="text"   name="code"         value=<?php echo $code;?>         required> <br><br>
    商品名    ：<input type="text"   name="itemName"     value=<?php echo $title;?>        required> <br><br>
    著者      ：<input type="text"   name="author"       value=<?php echo $author;?>       required> <br><br>
    出版社    ：<input type="text"   name="manufacturer" value=<?php echo $manufacturer;?> required> <br><br>
